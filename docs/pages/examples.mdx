...
import { Button, DialogRoot, DialogBackdrop, DialogPopup, DialogTitle, DialogClose } from '@bao-ui/react'
...
```tsx
import { Button, TooltipRoot, TooltipTrigger, TooltipPopup } from '@bao-ui/react'
    ...
    <TooltipRoot>
      ...
      <TooltipPopup>
        <div style={{ padding: '0.5rem' }}>
          ...
          <div style={{ color: '#666', fontSize: '0.875rem' }}>Software Engineer</div>
...
```tsx
import { useState } from 'react'
import { Button, DialogRoot, DialogPopup, DialogTitle, DialogClose } from '@bao-ui/react'
...
```tsx
import { Button, TooltipRoot, TooltipTrigger, TooltipPopup, DialogRoot, DialogTrigger, DialogPopup, DialogTitle } from '@bao-ui/react'
