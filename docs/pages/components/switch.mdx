...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview story={Default} />
</div>
...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview story={WithDescription} />
</div>
...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview story={{render: () => (
    <div className="space-y-4">
      {Default.render ? Default.render(Default.args || {}) : null}
      {Checked.render ? Checked.render(Checked.args || {}) : null}
      {Disabled.render ? Disabled.render(Disabled.args || {}) : null}
      {DisabledChecked.render ? DisabledChecked.render(DisabledChecked.args || {}) : null}
    </div>
  )}} />
</div>
...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview story={Controlled} />
</div>
...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview story={SettingsPanel} />
</div>
...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview story={CustomComposition} />
</div>
