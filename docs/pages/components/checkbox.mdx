import {
  ...
  CustomComposition,
  CustomIcon
} from '../../../packages/ui/src/components/Checkbox.stories'
...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview story={CheckboxGroup} />
</div>
...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview story={ParentChildCheckboxes} />
</div>
