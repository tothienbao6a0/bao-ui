...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview>
    <div className="space-y-3">
      ...
      <Checkbox label="SMS notifications" description="Receive updates via SMS" />
      <Checkbox label="Push notifications" description="Receive push notifications" />
    </div>
  </ComponentPreview>
</div>
...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview>
    <div className="space-y-3">
      <Checkbox label="Select all features" indeterminate />
      <div className="ml-6 space-y-2">
        <Checkbox label="Feature A" />
        <Checkbox label="Feature B" defaultChecked />
        <Checkbox label="Feature C" />
      </div>
    </div>
  </ComponentPreview>
</div>
...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview>
    <div className="flex items-center space-x-3">
      ...
      <div>
        <label className="text-sm font-medium">Custom composed checkbox</label>
        <p className="text-xs text-muted-foreground">Maximum flexibility with individual components</p>
      </div>
    </div>
  </ComponentPreview>
</div>
