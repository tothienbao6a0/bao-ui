...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview>
    <div className="space-y-2 w-full max-w-sm">
      <Input placeholder="Enter text..." />
      <p className="text-xs text-muted-foreground">This is a helpful description.</p>
    </div>
  </ComponentPreview>
</div>
...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview>
    <div className="space-y-4 w-full max-w-sm">
      ...
      <p className="text-sm text-muted-foreground">This input is controlled by React state</p>
    </div>
  </ComponentPreview>
</div>
...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview>
    <div className="space-y-2 w-full max-w-sm">
      ...
      <p className="text-xs text-muted-foreground">Using individual components for flexibility</p>
    </div>
  </ComponentPreview>
</div>
