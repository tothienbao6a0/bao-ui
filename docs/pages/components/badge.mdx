...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview story={Variants} />
</div>
...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview story={StatusBadges} />
</div>
...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview story={NotificationBadges} />
</div>
...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview story={InteractiveBadges} />
</div>
...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview story={UseCases} />
</div>
