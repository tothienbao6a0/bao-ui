import { Badge, StatusBadge, NotificationBadge, InteractiveBadge } from '@bao-ui/react'
...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview>
    <div className="flex items-center gap-6">
      ...
      <div className="relative">
        <div className="h-8 w-8 rounded bg-muted"></div>
        <NotificationBadge count={150} max={99} className="absolute -right-1 -top-1" />
      </div>
      <div className="relative">
        <div className="h-8 w-8 rounded bg-muted"></div>
        <NotificationBadge count={0} showZero className="absolute -right-1 -top-1" />
      </div>
    </div>
  </ComponentPreview>
</div>
...
<div className="my-6 rounded-lg border border-border bg-background">
  <ComponentPreview>
    <div className="flex flex-wrap gap-2">
      <InteractiveBadge variant="secondary" removable>
        React
      </InteractiveBadge>
      <InteractiveBadge variant="secondary" removable>
        TypeScript
