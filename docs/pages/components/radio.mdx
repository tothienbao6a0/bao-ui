import {
  ...
  CustomComposition,
  FormExample
} from '../../../src/components/Radio.stories'
...
<div className="my-6 rounded-lg border border-border bg-background p-6">
  <ClientOnly
    fallback={<div className="animate-pulse h-24 bg-muted rounded"></div>}
  >
    <Default />
  </ClientOnly>
</div>
...
<div className="my-6 rounded-lg border border-border bg-background p-6">
  <ClientOnly
    fallback={<div className="animate-pulse h-32 bg-muted rounded"></div>}
  >
    <WithItemDescriptions />
  </ClientOnly>
</div>
...
<div className="my-6 rounded-lg border border-border bg-background p-6">
  <ClientOnly fallback={<div className="animate-pulse h-32 bg-muted rounded"></div>}>
    <Sizes />
  </ClientOnly>
</div>
...
<div className="my-6 rounded-lg border border-border bg-background p-6">
  <ClientOnly fallback={<div className="animate-pulse h-24 bg-muted rounded"></div>}>
    <MixedStates />
  </ClientOnly>
</div>
